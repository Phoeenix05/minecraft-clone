...
Shader::Shader()
{
  ...
  auto l_vertexShaderCode = loadShader("/Users/antonfredriksson/GitHub/minecraft-clone/resources/vertex.glsl");
  compileShader(l_vertexShaderCode, l_vertexShaderID);

  auto l_fragmentShaderID = glCreateShader(GL_FRAGMENT_SHADER);
  auto l_fragmentShaderCode = loadShader("/Users/antonfredriksson/GitHub/minecraft-clone/resources/fragment.glsl");
